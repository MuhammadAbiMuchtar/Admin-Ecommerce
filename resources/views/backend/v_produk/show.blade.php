...
@section('content')
<!-- Awal konten utama detail produk -->
<div class="container-fluid">
    <!-- Row utama -->
    <div class="row">
        <div class="col-12">
            <!-- Kartu utama untuk detail produk -->
            <div class="card">
                <div class="card-body">
                    <!-- Judul halaman -->
                    <h4 class="card-title">{{ $judul }}</h4>
                    <div class="row">
                        <!-- Kolom Kiri: Form detail produk (readonly) -->
                        <div class="col-md-6">
                        ...
                        <!-- Kolom Kanan: Foto produk utama dan tambahan -->
                        <div class="col-md-6">
                             <div class="form-group">
...
<!-- Akhir konten utama detail produk -->
@endsection

<!-- Script untuk menambah input foto tambahan secara dinamis -->
<script>
